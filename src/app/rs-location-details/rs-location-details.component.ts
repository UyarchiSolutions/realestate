...
export class RsLocationDetailsComponent implements OnInit {
  ...
  routerlink = '/start-posting/residentaial-sale-location-details';
  OnSubmit() {
    this.submitted = true;
    if (this.rrlocform.valid) {
      ...
      this.service.formput(this.id, data).subscribe((res: any) => {
        ...
        this.router.navigateByUrl(
          '/start-posting/residential-sale-price-details?' + queryString
        );
        console.log(res);
      });
    }
  ...
  routetopreview() {
    ...
    if (this.rrlocform.valid) {
      ...
      var queryString = new URLSearchParams(postdata).toString();
      this.router.navigateByUrl(
        '/start-posting/residential-sale-preview?' + queryString
      );
  ...
  back(count: any) {
    ...
    if (count == 3) {
      ...
      var queryString = new URLSearchParams(data).toString();
      this.router.navigateByUrl(
        '/start-posting/residential-sale-amentites?' + queryString
      );
    ...
    if (count == 4) {
      ...
      var queryString = new URLSearchParams(postdata).toString();
      this.router.navigateByUrl(
        '/start-posting/residential-sale-gallery?' + queryString
      );
      this.service.formget(this.id).subscribe((res: any) => {});
    }
    if (count == 5) {
      ...
      var queryString = new URLSearchParams(postdata).toString();
      this.router.navigateByUrl(
        '/start-posting/residential-sale-add-details?' + queryString
      );
      this.service.formget(this.id).subscribe((res: any) => {});
    }
  }
