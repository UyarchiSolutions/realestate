...
@Component({
  selector: 'app-rs-gallery',
  templateUrl: './rs-gallery.component.html',
  styleUrls: ['./rs-gallery.component.css']
})
export class RsGalleryComponent implements OnInit{
    ...
    routerlink='/start-posting/residential-sale-gallery';
    submited=false;
